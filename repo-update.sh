...
pkgfiles=$(ls -v --ignore={manjaro-jp.,libarchive-,nvidia-,lib32-nvidia,libxnvctrl,virtualbox-host-dkms,zfs-utils,zfs-dkms,egl-gbm-,egl-wayland-,egl-x11-,python-legacy-cgi-}* --ignore=*.sig --ignore=*.html)
echo $pkgfiles

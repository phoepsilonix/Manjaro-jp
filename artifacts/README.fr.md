...
[série kernel-6.13](https://kernel.org/).
...
Windows  
Téléchargez [Ventoy](https://github.com/ventoy/Ventoy/releases/download/v1.1.00/ventoy-1.1.00-windows.zip) à l’aide d’un navigateur ou autre chose.  
...
4. différences entre le noyau et le noyau officiel de Manjaro
    ...
    L’ISO distribué ici utilise autant que possible un nouveau noyau. Actuellement, il s’agit de la série kernel-6.13.  

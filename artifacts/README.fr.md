...
[série kernel-6.6](https://kernel.org/).
...
Windows  
Téléchargez [Ventoy](https://github.com/ventoy/Ventoy/releases/download/v1.0.99/ventoy-1.0.99-windows.zip) à l’aide d’un navigateur ou autre chose.  
...
L’ISO distribué ici utilise autant que possible un nouveau noyau. Actuellement, il s’agit de la série kernel-6.9.  

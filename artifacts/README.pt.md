...
[kernel-6.13 series](https://kernel.org/).
...
Windows
Baixe o [Ventoy](https://github.com/ventoy/Ventoy/releases/download/v1.1.00/ventoy-1.1.00-windows.zip) usando um navegador ou algo assim.  
...
4. diferenças em relação ao kernel oficial do Manjaro
    ...
    O ISO distribuído aqui usa um novo kernel tanto quanto possível. Atualmente, é a série kernel-6.13.  

...
[Kernel-6.15 Serie](https://kernel.org/).
...
```
Windows  
Laden Sie [Ventoy](https://github.com/ventoy/Ventoy/releases/download/v1.1.05/ventoy-1.1.05-windows.zip) mit einem Browser oder etwas herunter.  
...
4. Kernel-Unterschiede zum offiziellen Manjaro-Kernel
    ...
    Die hier verteilte ISO verwendet so weit wie möglich einen neuen Kernel. Derzeit ist es die Kernel-6.15-Serie.  

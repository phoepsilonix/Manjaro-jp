...
[Kernel-6.10 Serie](https://kernel.org/).
...
```
Windows  
Laden Sie [Ventoy](https://github.com/ventoy/Ventoy/releases/download/v1.0.99/ventoy-1.0.99-windows.zip) mit einem Browser oder etwas herunter.  
...
Die Kererl-6.6-Serie wurde in der offiziellen Manjaro-ISO verwendet. Das neueste Manjaro scheint auf die Kernel-6.9-Serie umgestiegen zu sein.  
Die hier verteilte ISO verwendet so weit wie möglich einen neuen Kernel. Derzeit ist es die Kernel-6.10-Serie.  
